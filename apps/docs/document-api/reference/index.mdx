...
| [`format.italic`](./format/italic) | Format | `format.italic` | Yes | `conditional` | Yes | Yes |
| [`format.underline`](./format/underline) | Format | `format.underline` | Yes | `conditional` | Yes | Yes |
| [`format.strikethrough`](./format/strikethrough) | Format | `format.strikethrough` | Yes | `conditional` | Yes | Yes |
