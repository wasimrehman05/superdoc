...
sidebarTitle: format.underline
description: Generated reference for format.underline
---
...
- Operation ID: `format.underline`
- API member path: `editor.doc.format.underline(...)`
